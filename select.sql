...
SELECT * FROM students WHERE country NOT IN('USA','UK','Canada') LIMIT 5 OFFSET 3;

SELECT * from students WHERE dob BETWEEN '2000-01-01' and '2005-01-01' ORDER BY dob ASC;

SELECT * FROM students WHERE first_name LIKE '%a';
SELECT * FROM students WHERE first_name LIKE 'A%';
SELECT * FROM students WHERE first_name LIKE '__a_c';
...
DELETE FROM students WHERE country='USA' AND grade='A';

UPDATE students 
         set email='defaultEmail@gmail.com'
         WHERE email is NULL;

SELECT * FROM students WHERE email='defaultEmail@gmail.com';